...
cam_dark = run_dark.get_array('SPB_EHD_HPVX2_2/CAM/CAMERA:daqOutput','data.image.pixels')
...
data_flat = file_flat.get_array('SPB_EHD_HPVX2_2/CAM/CAMERA:daqOutput','data.image.pixels')
...
if path[-1] != '/':
    path+='/'
filename = path + "pca_info_cam2" + "_flat_run" + str(run_number_flat) + "_rank" + str(n_components) + ".h5"
