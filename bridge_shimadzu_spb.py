...
online device
    ...
    plots SPB camera images 
    plots the mean of each shimadzu image and the mean of all images in a plot and image widget
...
# interface = 'tcp://10.253.0.52:54445' 
interface = 'tcp://10.253.0.52:54446' # SPB
...
class imageView(QtGui.QMainWindow):
    def __init__(self, interface,  parent=None, title=None):
        ...
        self.setWindowTitle('Shimadzu SPB Camera View')

        self.d1 = Dock("Shimadzu SPB", size=(800,800))
    ...
    def update(self, data):
        ...
        print(type(data))
        if deviceId_name['shimadzu_spb'] in data.keys():
            imageData1 = np.array( data[deviceId_name['shimadzu_spb']][deviceId_property['camera']]*1. )
